      ...
      <div className="group bg-white dark:bg-slate-900 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="p-6">
          ...
          <Button 
            ...
            onClick={() => setActiveTab('challenge',  challenge.id)}
          >
            View Challenge
          </Button>
        </div>
      ...
      <div className="px-4 py-3 flex items-center gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 mb-1">
            <h3 className="text-xs font-semibold text-slate-900 dark:text-white truncate">{challenge.title}</h3>
          ...
          <div className="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
            ...
            <span className="flex items-center gap-1">
              ...
              {challenge.daysLeft > 0 ? `${challenge.daysLeft}d left` : 'Expired'}
            </span>
          </div>
        </div>
      </div>
