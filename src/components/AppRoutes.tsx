...
import PublicTeamDiscovery from '@/pages/PublicTeamDiscovery';
import JoinTeamByLink from '@/pages/JoinTeamByLink';
import { ProtectedRoute } from './ProtectedRoute';

export function AppRoutes() {
  const location = useLocation();
  const noHeaderPaths = ['/dashboard', '/signin', '/signup', '/partner-pending', '/partner/dashboard', '/admin/dashboard'];
    ...
    <>
      ...
      <div className={showHeader ? "pt-16" : ""}> {/* Only add padding when header is shown */}
        <Routes>
          ...
          <Route path="/teams/discover" element={<PublicTeamDiscovery />} />
          <Route path="/teams/join/:linkCode" element={<JoinTeamByLink />} />
